<template>
  <div class="case-page">
    <PageTitle
      :case-page-subtitle="caseData?.casePageSubtitle"
      :title="caseData?.title"
      :slug="caseData?.slug"
    />
    <CasePreview
      v-if="!isRolling"
      :case-preview-box="caseData?.box"
      :case-preview-logo="caseData?.logo"
    />
    <CaseRoller
      v-else
      :case-data="caseData"
      :roller-items="rollerItems"
    ...
    <OpenCounter
      ...
      :instant-roll="instantRoll"
      :is-rolling="isRolling"
    />
    <CaseContents v-if="caseData" :case-data="caseData" />
    <CaseList v-if="caseData?.caseWrapperCollection" :case-data="caseData.caseWrapperCollection" />
    <BasicInput />
  </div>
</template>
